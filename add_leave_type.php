...
<head>
 ...
 <div class="container1">
    ...
    <form method="POST">
      <div class="div" >
      <label for="leave_type" class=" text"><strong>Leave Type</strong></label><br>
        <input type="text" value="<?php echo $leave_type?>" name="leave_type" placeholder="Enter your leave type" class="input1" required></div><br>
      </div>
